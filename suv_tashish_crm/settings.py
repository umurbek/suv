"""
Django settings for suv_tashish_crm project.
...
SECRET_KEY = 'django-insecure-tmh!3n1^z)cwrc3!j7iq*rz%(&bwpexu+%b1&e^1ge3e)(qa6#'
...
# Django REST Framework + CORS (basic dev setup)
REST_FRAMEWORK = {
...
# For development only: allow all origins. In production restrict this.
...
TELEGRAM_CHAT_ID="-1003330737132"